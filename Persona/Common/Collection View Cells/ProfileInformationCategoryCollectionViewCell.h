...
static const CGSize ProfileInformationCategoryCollectionViewCellSize = {150.0f, 58.0f};
static const UIEdgeInsets ProfileInformationCategoryCollectionViewSectionInset = {32.0f, 12.0f, 32.0f, 12.0f};
